...
public class UserDao implements IUserDao {
	/*
	 * For reference visit:
	 * http://monstersandwich.blogspot.com/2010/04/spring
	 * -transactions-sample-applications.html
	 */
	...
	public int insertUser(User user) {
		...
		// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		/*
		 * To test the transaction propagation behaviour call another
		 * transacted method. So in this case when you call selectUser,
		 * transaction behaviour as described in xml can be practically
		 * seen
		 */
		dao.selectUser(3);
		// ///////////////// IMPORTANT/////////////////////////////
	...
	public User selectUser(int uid) {
		// for all the RuntimeExceptions the transactions will be
		// automatically
		// rolled back
	...
	public int updateUser(User user) throws Exception {
		/*
		 * for checked exceptions, transactions are not rolled back by
		 * default. The rolled back behaviour can be controlled by
		 * mentioning properties in xml file. Please chk
		 */
