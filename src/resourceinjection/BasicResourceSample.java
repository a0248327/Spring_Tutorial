...
public class BasicResourceSample {
	 ...
	 * simple and handly object containing all the info of the resource 1.
	 * Using a url like http, ftp, file etc. We can use URLResource. This
	 * utility wraps the java.net.URL 2. Getting a file system resource
	 * using FileSystemResource. This wraps the java.io.File 3.
	 * ClasspathResource is used to get a resource from the classpath.
	 * 
	 */
	public static void main(String[] args) throws Exception {
		...
		try {
			resource = new FileSystemResource("src/resourceinjection/sample.txt");
			inputStream = resource.getInputStream();
